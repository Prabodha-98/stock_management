            ...
            <div class="col-xxl-6">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Issue Pen</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name = "quantity" placeholder="Enter the quantity" id="firstNameinput">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="lastNameinput" class="form-label">Issue to</label>
                                            <input type="text" class="form-control"name = "issue-to" placeholder="Enter name" id="lastNameinput">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="nameInput" class="form-label">Issue By</label>
                                            <input type="name" class="form-control" name = "issue-by" placeholder="Enter Your Name" id="name">
                                        </div>
                                    </div>
                                    <!--end col-->
