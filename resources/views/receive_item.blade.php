            ...
            <div class="col-xxl-6">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Receive Pen</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="quantity" class="form-control" placeholder="Enter the quantity" id="firstNameinput">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="lastNameinput" class="form-label">Receive By</label>
                                            <input type="text" name="receiveby" class="form-control" placeholder="Enter name" id="lastNameinput">
                                        </div>
                                    </div>
                                    <!--end col-->
