...
<!-- Mirrored from themesbrand.com/velzon/html/galaxy/apps-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Sep 2023 07:22:10 GMT -->
<head>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                                <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Stocks Management</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="/create-stock" class="nav-link" data-key="t-analytics"> Create Stock </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/manage-stock" class="nav-link" data-key="t-crm"> Manage Stock </a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="/issue-item" class="nav-link" data-key="t-crm"> Issue Item </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/receive-item" class="nav-link" data-key="t-crm"> Receive Item </a>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="col-xxl-6">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Update Item</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="category" class="form-control" placeholder="Enter the category" value="{{$item->category}}" id="firstNameinput">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="lastNameinput" class="form-label">Item Name</label>
                                            <input type="text" name="name" class="form-control" value="{{$item->name}}" placeholder="Enter Item name" id="lastNameinput">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="compnayNameinput" class="form-label">Quantity</label>
                                            <input type="text" name="quantity" class="form-control" value="{{$item->quantity}}" placeholder="Enter quantity" id="compnayNameinput">
                                        </div>
                                    </div>
