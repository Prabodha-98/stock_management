                                    ...
                                    <div class="listjs-table" id="customerList">
                                        <div class="row g-4 mb-3">
                                            <div class="col-sm-auto">
                                                <div>
                                        <a href="/create-stock"> <button type="button" class="btn btn-primary add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add</button></a>
                                            ...
                                            <table class="table align-middle table-nowrap" id="customerTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="email">ITEM NAME</th>
                                                        <th class="sort" data-sort="phone">QUANTITY IN STORE</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="phone">{{{$data->quantity}}}</td>
                                                        <td class="status"><span class="badge bg-success-subtle text-success text-uppercase">Active</span></td>
                                                        <td>
                                                            <div class="d-flex gap-2">

                                                                    <div class="text-end">
                                                                       <a href="{{ route('items.edit', $data->id) }}"> <button type="submit" class="btn btn-sm btn-primary edit-item-btn">Update</button> </a>

                                                                    </div>
                                                                </form>

                                                                <div class="remove">
                                                                      <a href="{{ route('items.delete', $data->id) }}" >
